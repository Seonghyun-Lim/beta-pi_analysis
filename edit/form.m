...
if i ~= i_max
   ...
   %disp('Unknown type of limit-state function parameter input.')
    ...
    formresults.disp = 'None'      % changed (Seonghyun Lim)
    formresults.iter = 0;          % changed (Seonghyun Lim)
    formresults.pf1 = 0;           % changed (Seonghyun Lim)
    formresults.beta1 = 0;         % changed (Seonghyun Lim)
end
